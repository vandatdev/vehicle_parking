<?php
    ...
    $out = $vehicle->getMember($thisTime);
    $field = $vehicle->fieldMember();
?>
...
<body>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="list-member.php">Manage Member</a></li>
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text" for="inputGroupSelect01">
                                            <strong>Members of Month</strong>
                                        </label>
                                    </div>
    ...
    <script>
        function Outgoing(){
            ...
            // console.log(month);
            $.ajax({
                url: 'assets/ajax/member.php',
                type: 'POST',
                data: {
                    month_data: month
                },
                success: function(result){
                    $('#memberBody').html(result)
                }
            })
        }
    </script>
